			...
			<div class="col-xs-10">
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?user-master-config" method="post" class="form-horizontal" style="padding-top:10px;margin-bottom:0px;">
						...
						<div class="form-group">
							<label for="seo_keywords" class="col-sm-2 control-label">QQ邮箱密码：</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="regfields" class="form-control" name="args[appsetting][regfields]" class="input-xxlarge">{x2;$app['appsetting']['regfields']}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="outfields" class="col-sm-2 control-label">导出所需字段：</label>
							<div class="col-sm-9">
								<textarea id="outfields" class="form-control" name="args[appsetting][outfields]" class="input-xxlarge">{x2;$app['appsetting']['outfields']}</textarea>
							</div>
						</div>
						<div class="form-group">
