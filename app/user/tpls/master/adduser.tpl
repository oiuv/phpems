                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0;">
                    ...
                    <form action="index.php?user-master-user-add" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" name="args[username]" id="username" size="25" type="text"
                                       value="" needle="needle" datatype="username" max="40" alt="请输入用户名称"
                                       msg="用户名必须为长度不少于3的中英文字符"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" type="password" id="password1" needle="needle"
                                       datatype="password" min="6" max="20" msg="密码应为长度在6-20位之间，不为空格的字符"
                                       name="args[userpassword]"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" type="password" id="password2" equ="password1"
                                       needle="needle" datatype="password" msg="重复密码必须和之前的密码一致"
                                       name="args[userpassword2]"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" type="text" id="email" needle="needle" datatype="email"
                                       name="args[useremail]" msg="请输入正确格式的电子邮箱，如abc@163.com"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="modules" class="form-control combox" name="args[usergroupid]"
                                        needle="needle" msg="您必须为这个用户选择一个模型" target="groupid"
                                        refUrl="index.php?user-master-ajax-getActorsByModule&moduleid={value}">
                        ...
                        <div class="form-group">
                            <label for="groupid" class="control-label col-sm-2">角色</label>
                            <div class="col-sm-4">
                                <select id="groupid" class="form-control" name="args[usergroupid]" needle="needle"
                                        msg="您必须为这个用户选择一个角色" autocomplete="off" default="请先选择模型">
