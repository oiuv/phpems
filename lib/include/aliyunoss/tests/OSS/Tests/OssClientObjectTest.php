...
class OssClientObjectTest extends TestOssClientBase
{
    public function testGetObjectMeta()
    {
        ...
        try {
            ...
            $this->assertSame('text/plain', $res['content-type']);
            $this->assertSame('Accept-Encoding', $res['vary']);
        ...
        try {
            ...
            $this->assertSame('gzip', $res['content-encoding']);
        } catch (OssException $e) {
            $this->assertTrue(false);
        }
    }
    ...
    public function testGetObjectWithHeader()
    {
        ...
        try {
            ...
            $this->assertSame('"/ilegal.txt" object name is invalid', $e->getMessage());
        }
    }
    ...
    public function testObject()
    {
        ...
        try {
            ...
            $this->assertSame('stringtype', $result[0]);
        } catch (OssException $e) {
            $this->assertSame('objects must be array', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame('notexist.txt file does not exist', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertSame($content, file_get_contents(__FILE__));
        } catch (OssException $e) {
            $this->assertFalse(true);
        }
        ...
        try {
            ...
            if (false == strpos($e, 'The specified key does not exist')) {
                $this->assertTrue(true);
            }
        }
        ...
        try {
            ...
            $this->assertSame(strlen('2016-11-21T03:46:58.000Z'), strlen($result[0]));
            $this->assertSame(strlen('"5B3C1A2E053D763E1B002CC607C5A0FE"'), strlen($result[1]));
        } catch (OssException $e) {
            $this->assertFalse(true);
        ...
        try {
            ...
            $this->assertSame($list[1], $result[0]);
            $this->assertSame($list[0], $result[1]);
    ...
    public function testAppendObject()
    {
        ...
        try {
            ...
            $this->assertSame($position, strlen($content_array[0]));
            $position = $this->ossClient->appendObject($this->bucket, $object, $content_array[1], $position);
            $this->assertSame($position, strlen($content_array[0]) + strlen($content_array[1]));
            $position = $this->ossClient->appendObject($this->bucket, $object, $content_array[2], $position);
            $this->assertSame($position, strlen($content_array[0]) + strlen($content_array[1]) + strlen($content_array[1]));
        } catch (OssException $e) {
            $this->assertFalse(true);
        }
        ...
        try {
            $content = $this->ossClient->getObject($this->bucket, $object);
            $this->assertSame($content, implode($content_array));
        } catch (OssException $e) {
            $this->assertFalse(true);
        }
        ...
        try {
            ...
            $this->assertSame($position, filesize(__FILE__));
            $position = $this->ossClient->appendFile($this->bucket, $object, __FILE__, $position);
            $this->assertSame($position, filesize(__FILE__) * 2);
        } catch (OssException $e) {
            $this->assertFalse(true);
        }
        ...
        try {
            $content = $this->ossClient->getObject($this->bucket, $object);
            $this->assertSame($content, file_get_contents(__FILE__).file_get_contents(__FILE__));
        } catch (OssException $e) {
            $this->assertFalse(true);
        }
