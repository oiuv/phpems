...
BBBB;
    ...
    public function testParseValidXml()
    {
        ...
        $this->assertSame(2, count($bucketListInfo->getBucketList()));
    }
    ...
    public function testParseNullXml()
    {
        ...
        $this->assertNotNull($result->getRawResponse());
        $bucketListInfo = $result->getData();
        $this->assertSame(0, count($bucketListInfo->getBucketList()));
    }
...
BBBB;
        ...
        try {
            ...
            $this->assertSame($e->getErrorMessage(), 'The specified bucket does not exist.');
            $this->assertSame($e->getDetails(), $errorBody);
        }
    }
}
