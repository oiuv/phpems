                    ...
                    <form action="index.php?bank-master-coupon-batadd" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" name="createnumber" id="createnumber" type="text"
                                           needle="needle" datatype="number" max="2" alt="请输入生成数量" msg="每次生成数量最多为99个"
                                           value="10"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" id="couponvalue" needle="needle"
                                           datatype="number" min="2" max="4" msg="分值应在10-9999之间" name="couponvalue"
                                           value="100"/>
