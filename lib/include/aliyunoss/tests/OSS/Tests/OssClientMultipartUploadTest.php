...
class OssClientMultipartUploadTest extends TestOssClientBase
{
    public function testInvalidDir()
    {
        try {
            ...
            $this->assertSame('parameter error: abc/ds/s/s/notexitst is not a directory, please check it', $e->getMessage());
        }
    }
    ...
    public function testMultipartUploadBigFile()
    {
        ...
        try {
            ...
            $this->assertSame(md5_file($bigFileName), md5_file($localFilename));
        } catch (OssException $e) {
    ...
    public function testCopyPart()
    {
        ...
        $this->assertSame($this->ossClient->getObject($this->bucket, $object), file_get_contents(__FILE__));
        $this->assertSame($this->ossClient->getObject($this->bucket, $copiedObject), file_get_contents(__FILE__));
    }
    ...
    public function testAbortMultipartUpload()
    {
        ...
        $this->assertSame(1, count($listPartsInfo->getListPart()));
        ...
        $this->assertSame($numOfMultipartUpload1 - 1, $numOfMultipartUpload2);
    }
