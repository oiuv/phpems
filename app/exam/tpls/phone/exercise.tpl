    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div style="clear:both;overflow:hidden;background:#FFFFFF;margin-top:0.5rem;padding:1rem;">
                <form action="index.php?exam-phone-exercise" id="exer" method="post" class="form-inline"
                      data-page="paper" data-target="paper">
                    <div class="form-group">
                        <label for="subject" class="control-label col-sm-2">请选择章节：</label>
                        <div class="col-sm-9">
                            <select autocomplete="off" id="thesectionid" name="args[sectionid]"
                                    class="combox form-control" ref="theknowsid"
                                    refUrl="index.php?exam-phone-index-ajax-getknowsbysectionid&sectionid={value}"
                                    more="questionnumbers" callback="getSectionContent">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select autocomplete="off" name="args[knowsid]" id="theknowsid" class="combox form-control"
                                    ref="questionnumbers"
                                    refUrl="index.php?exam-phone-exercise-ajax-getQuestionNumber&sectionid={tmp}&knowsid={value}"
                                    tmp="thesectionid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" needle="needle" msg="做题时间" name="args[time]" class="form-control"
                                   value='60'/>
                        </div>
                    </div>
                    <div class="form-group">
