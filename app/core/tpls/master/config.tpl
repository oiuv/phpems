        ...
        <div class="main">
            ...
            <div class="col-xs-10">
                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0;">
                    ...
                    <form action="index.php?core-master-apps-config" method="post" class="form-horizontal"
                          style="padding-top:10px;margin-bottom:0px;">
                        <div class="form-group">
                            <label for="appname" class="col-sm-2 control-label">模块名称：</label>
                            <div class="col-sm-6">
                                <input id="appname" class="form-control" name="args[appname]" type="text"
                                       value="{x2;$app['appname']}" needle="needle" msg="您必须输入模块名称"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input name="args[appstatus]" type="radio" value="1"
                                           {x2;if:$app['appstatus']}checked{x2;endif}/>开启
                                </label>
                                <label class="radio-inline">
                                    <input name="args[appstatus]" type="radio" value="0"
                                           {x2;if:!$app['appstatus']}checked{x2;endif}/>禁用
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <script type="text/template" id="pe-template-basicthumb">
                                    <div class="qq-uploader-selector" style="width:27%" qq-drop-area-text="可将图片拖拽至此处上传"
                                         style="clear:both;">
                                                ...
                                                <li class="text-center">
                                                    <div class="thumbnail">
                                                        <img class="qq-thumbnail-selector"
                                                             src="{x2;if:$app['appthumb']}{x2;$app['appthumb']}{x2;else}app/core/styles/images/noimage.gif{x2;endif}"
                                                             alt="点击上传新图片">
                                                        <input type="hidden" class="qq-edit-filename-selector"
                                                               name="args[appthumb]" tabindex="0"
                                                               value="{x2;if:$app['appthumb']}{x2;$app['appthumb']}{x2;else}app/core/styles/images/noimage.gif{x2;endif}">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="fineuploader" attr-type="thumb"
                                     attr-template="pe-template-basicthumb"></div>
                            </div>
                        </div>
                        <!--
						<div class="form-group">
