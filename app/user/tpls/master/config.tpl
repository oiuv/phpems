        ...
        <div class="main">
            ...
            <div class="col-xs-10">
                ...
                <div class="box itembox" style="padding-top:10px;margin-bottom:0;">
                    ...
                    <form action="index.php?user-master-config" method="post" class="form-horizontal"
                          style="padding-top:10px;margin-bottom:0px;">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">注册选项：</label>
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input name="args[appsetting][closeregist]" type="radio" value="0"
                                           {x2;if:!$app['appsetting']['closeregist']}checked{x2;endif}/>开启注册
                                </label>
                                <label class="radio-inline">
                                    <input name="args[appsetting][closeregist]" type="radio" value="1"
                                           {x2;if:$app['appsetting']['closeregist']}checked{x2;endif}/>关闭注册
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input name="args[appsetting][registype]" type="radio" value="0"
                                           {x2;if:!$app['appsetting']['registype']}checked{x2;endif}/>经典模式
                                </label>
                                <label class="radio-inline">
                                    <input name="args[appsetting][registype]" type="radio" value="1"
                                           {x2;if:$app['appsetting']['registype']}checked{x2;endif}/>自定义模式
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input name="args[appsetting][managemodel]" type="radio" value="0"
                                           {x2;if:!$app['appsetting']['managemodel']}checked{x2;endif}/>关闭权限区分
                                </label>
                                <label class="radio-inline">
                                    <input name="args[appsetting][managemodel]" type="radio" value="1"
                                           {x2;if:$app['appsetting']['managemodel']}checked{x2;endif}/>开启权限区分
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input name="args[appsetting][loginmodel]" type="radio" value="0"
                                           {x2;if:!$app['appsetting']['loginmodel']}checked{x2;endif}/>不限登录
                                </label>
                                <label class="radio-inline">
                                    <input name="args[appsetting][loginmodel]" type="radio" value="1"
                                           {x2;if:$app['appsetting']['loginmodel']}checked{x2;endif}/>后登陆踢掉已登录者
                                </label>
                            </div>
                        </div>
                        <!--
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea id="regfields" class="form-control" name="args[appsetting][regfields]"
                                          class="input-xxlarge">{x2;$app['appsetting']['regfields']}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="outfields" class="col-sm-2 control-label">导出所需字段：</label>
                            <div class="col-sm-9">
                                <textarea id="outfields" class="form-control" name="args[appsetting][outfields]"
                                          class="input-xxlarge">{x2;$app['appsetting']['outfields']}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
