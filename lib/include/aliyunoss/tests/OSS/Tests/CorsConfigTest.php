...
BBBB;
    ...
    public function testParseValidXml2()
    {
        ...
        $this->assertSame($this->cleanXml($this->validXml2), $this->cleanXml($corsConfig->serializeToXml()));
    }
    ...
    public function testCreateCorsConfigFromMoreThan10Rules()
    {
        ...
        try {
            ...
            $this->assertSame($e->getMessage(), 'num of rules in the config exceeds self::OSS_MAX_RULES: '.strval(CorsConfig::OSS_MAX_RULES));
        }
    }
    ...
    public function testCreateCorsConfigParamAbsent()
    {
        ...
        try {
            ...
            $this->assertSame($e->getMessage(), 'maxAgeSeconds is not set in the Rule');
        }
    }
    ...
    public function testCreateCorsConfigFromScratch()
    {
        ...
        $corsConfig->addRule($rule);
        $this->assertSame($this->cleanXml($this->validXml2), $this->cleanXml($corsConfig->serializeToXml()));
        $this->assertSame($this->cleanXml($this->validXml2), $this->cleanXml(strval($corsConfig)));
    }
