                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                {x2;if:is_array($search)}{x2;tree:$search,arg,aid}<input type="hidden"
                                                                                                         name="search[{x2;v:key}]"
                                                                                                         value="{x2;v:arg}"/>{x2;endtree}{x2;endif}
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9"><span
                                                        class="help-block">{x2;$user['useremail']}</span></div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" name="groupid" id="groupid">
                                                    ...
                                                    <option value="{x2;v:group['groupid']}"
                                                            {x2;if:$user['usergroupid'] == v:group['groupid']}selected{x2;endif}>{x2;v:group['groupname']}</option>
                                                    {x2;endtree}
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <form action="index.php?user-master-user-modify" method="post" class="form-horizontal">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="passowrd1" type="password"
                                                       name="args[password]" needle="true" datatype="password"
                                                       msg="密码字数必须在6位以上"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" id="password2" type="password"
                                                       name="args[password2]" needle="true" equ="passowrd1"
                                                       msg="前后两次密码必须一致且不能为空"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
