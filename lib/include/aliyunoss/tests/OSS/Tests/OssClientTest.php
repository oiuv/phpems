...
class OssClientTest extends \PHPUnit_Framework_TestCase
{
    public function testConstrunct()
    {
        try {
            ...
            $this->assertSame(3, $ossClient->getMaxRetries());
            $ossClient->setMaxTries(4);
            $this->assertSame(4, $ossClient->getMaxRetries());
    ...
    public function testConstrunct2()
    {
        try {
            ...
            $this->assertSame('access key secret is empty', $e->getMessage());
        }
    }
    ...
    public function testConstrunct3()
    {
        try {
            ...
            $this->assertSame('access key id is empty', $e->getMessage());
        }
    }
    ...
    public function testConstrunct4()
    {
        try {
            ...
            $this->assertSame('endpoint is empty', $e->getMessage());
        }
    }
    ...
    {
        $this->assertSame($result['info']['primary_ip'], $proxys['host']);
        $this->assertSame($result['info']['primary_port'], $proxys['port']);
