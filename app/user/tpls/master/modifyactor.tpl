                    ...
                    <form action="index.php?user-master-actor-modifyactor" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="args[groupname]" type="text"
                                           value="{x2;$group['groupname']}" id="groupname" size="25" needle="needle"
                                           maxlength="40" msg="请输入角色名称"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="7" id="groupdescribe"
                                              name="args[groupdescribe]">{x2;$group['groupdescribe']}</textarea>
