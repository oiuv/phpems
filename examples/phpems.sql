/*
 ...
 Source Schema         : phpems_v5

 Target Server Type    : MySQL
 Target Server Version : 100028
 File Encoding         : 65001

 Date: 27/12/2019 12:35:52
*/
...
CREATE TABLE `x2_dayexam`  (
  ...
  `deday` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `deexamid` int(11) NULL DEFAULT NULL,
  `deinfo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  PRIMARY KEY (`deid`) USING BTREE,
  UNIQUE INDEX `deday`(`deday`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `x2_exams`  (
  ...
  `examquestions` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `x2_examsession`  (
  ...
  `examsessionsetting` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `examsessionsign` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `examsessionuseranswer` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `examsessionscorelist` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `examsessionissave` int(1) NOT NULL DEFAULT 0,
  `examsessiontimelist` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
-- Records of x2_knows
-- ----------------------------
INSERT INTO `x2_knows` VALUES (1, '第一节 鸦片战争前的中国和世界', 1, '', 1);
INSERT INTO `x2_knows` VALUES (2, '第二节 资本—帝国主义对中国的侵略及近代中国社会的演变', 1, '', 1);
INSERT INTO `x2_knows` VALUES (3, '第三节 抵御外来侵略、争取民族独立的斗争', 1, '', 1);
INSERT INTO `x2_knows` VALUES (4, '第一节 农民群众斗争风暴的起落', 2, '', 1);
INSERT INTO `x2_knows` VALUES (5, '第二节 地主阶级统治集团“自救”活动的兴衰', 2, '', 1);
INSERT INTO `x2_knows` VALUES (6, '第三节 维新运动的兴起和夭折', 2, '', 1);
INSERT INTO `x2_knows` VALUES (7, '第一节 举起近代民族民主革命的旗帜', 3, '', 1);
INSERT INTO `x2_knows` VALUES (8, '第二节 辛亥革命的胜利与失败', 3, '', 1);
INSERT INTO `x2_knows` VALUES (9, '第一节 新文化运动与五四运动', 4, '', 1);
INSERT INTO `x2_knows` VALUES (10, '第二节 马克思主义传播与中国共产党诞生', 4, '', 1);
INSERT INTO `x2_knows` VALUES (11, '第三节 国共合作与国民革命', 4, '', 1);
INSERT INTO `x2_knows` VALUES (12, '第一节 国民党在全国的统治和中间党派的政治主张', 5, '', 1);
INSERT INTO `x2_knows` VALUES (13, '第二节 中国共产党对革命新道路的艰苦探索', 5, '', 1);
INSERT INTO `x2_knows` VALUES (14, '第三节 中国革命在探索中曲折前进', 5, '', 1);
INSERT INTO `x2_knows` VALUES (15, '第一节 日本发动灭亡中国的侵略战争', 6, '', 1);
INSERT INTO `x2_knows` VALUES (16, '第二节 从局部抗战到全国性抗战', 6, '', 1);
INSERT INTO `x2_knows` VALUES (17, '第三节 国民党的正面战场与大后方的抗日民主运动', 6, '', 1);
INSERT INTO `x2_knows` VALUES (18, '第四节 中国共产党成为抗日战争的中流砥柱', 6, '', 1);
INSERT INTO `x2_knows` VALUES (19, '第五节 抗日战争的胜利及其意义', 6, '', 1);
INSERT INTO `x2_knows` VALUES (20, '第一节 从争取和平民主到进行自卫战争', 7, '', 1);
INSERT INTO `x2_knows` VALUES (21, '第二节 国民党政府处在全民的包围中', 7, '', 1);
INSERT INTO `x2_knows` VALUES (22, '第三节 人民共和国：中国人民的历史性选择', 7, '', 1);
INSERT INTO `x2_knows` VALUES (23, '第一节 《共同纲领》的全面实施与新民主主义革命任务的胜利完成', 8, '', 1);
INSERT INTO `x2_knows` VALUES (24, '第二节 制定过渡时期总路线', 8, '', 1);
INSERT INTO `x2_knows` VALUES (25, '第三节 开辟中国社会主义改造道路', 8, '', 1);
INSERT INTO `x2_knows` VALUES (26, '第一节 良好的开局', 9, '', 1);
INSERT INTO `x2_knows` VALUES (27, '第二节 探索中的严重曲折', 9, '', 1);
INSERT INTO `x2_knows` VALUES (28, '第三节 建设的成就 探索的成果', 9, '', 1);
INSERT INTO `x2_knows` VALUES (29, '第一节 历史性的伟大转折和改革开放的起步', 10, '', 1);
INSERT INTO `x2_knows` VALUES (30, '第二节 改革开放和现代化建设新局面的展开', 10, '', 1);
INSERT INTO `x2_knows` VALUES (31, '第三节 改革开放和现代化建设发展的新阶段', 10, '', 1);
INSERT INTO `x2_knows` VALUES (32, '第四节 在新的历史起点上推进中国特色社会主义', 10, '', 1);
INSERT INTO `x2_knows` VALUES (33, '第五节 改革开放和社会主义现代化建设的成就', 10, '', 1);
...
CREATE TABLE `x2_module`  (
  ...
  `moduleallowreg` tinyint(1) NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `x2_sections` VALUES (1, '第一章 反对外国侵略的斗争', 1, '');
INSERT INTO `x2_sections` VALUES (2, '第二章 对国家出路的早期探索', 1, '');
INSERT INTO `x2_sections` VALUES (3, '第三章 辛亥革命', 1, '');
INSERT INTO `x2_sections` VALUES (4, '第四章 开天辟地的大事变', 1, '');
INSERT INTO `x2_sections` VALUES (5, '第五章 中国革命的新道路', 1, '');
INSERT INTO `x2_sections` VALUES (6, '第六章 中华民族的抗日战争', 1, '');
INSERT INTO `x2_sections` VALUES (7, '第七章 为创建新中国而奋斗', 1, '');
INSERT INTO `x2_sections` VALUES (8, '第八章 社会主义基本制度的全面确立', 1, '');
INSERT INTO `x2_sections` VALUES (9, '第九章 社会主义建设在探索中曲折发展', 1, '');
INSERT INTO `x2_sections` VALUES (10, '第十章 改革开放与现代化建设新时期', 1, '');
...
CREATE TABLE `x2_seminar`  (
  ...
  `seminartpl` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `seminaruserid` int(11) NOT NULL DEFAULT 0,
  `seminarusername` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  INDEX `seminarsequence`(`seminarsequence`) USING BTREE,
  INDEX `seminaruserid`(`seminaruserid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `x2_session` VALUES ('hequ0n963686e5jgvj72e6i9ev', 1, 'peadmin', '244153a2599be7685c32d2281f57ae67', '192.168.1.4', 0, 1, '', '', 1577280705, 1577280705, 1577364567, 0);
...
CREATE TABLE `x2_special`  (
  ...
  `contentusername` varchar(48) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `contenttitle` varchar(240) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `contentthumb` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `contentlink` varchar(240) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `contentinputtime` int(11) NOT NULL DEFAULT 0,
  `contentmodifytime` int(11) NOT NULL DEFAULT 0,
  `contentsequence` int(4) NOT NULL DEFAULT 0,
  ...
  `contenttemplate` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `contenttext` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`specialid`) USING BTREE,
  INDEX `contentuserid`(`contentuserid`, `contentinputtime`, `contentmodifytime`, `contentsequence`) USING BTREE,
  INDEX `contentmoduleid`(`contentmoduleid`) USING BTREE,
  INDEX `contentcatid`(`contentcatid`) USING BTREE,
  INDEX `contentstatus`(`contentstatus`) USING BTREE,
  INDEX `contentspecialid`(`contentspecialid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `x2_specialsort`  (
  ...
  `sorttitle` varchar(240) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `sortthumb` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `sorttpl` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `sortseminarid` int(11) NOT NULL DEFAULT 0,
  `sortsequence` int(11) NOT NULL DEFAULT 0,
  `sortdescribe` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`sortid`) USING BTREE,
  INDEX `sortseminarid`(`sortseminarid`, `sortsequence`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of x2_user
-- ----------------------------
INSERT INTO `x2_user` VALUES (1, '', 'peadmin', '958074@163.com', '244153a2599be7685c32d2281f57ae67', 205, '127.0.0.1', 1471795200, 0, NULL, 1, 0, 'a:5:{i:0;s:4:\"user\";i:1;s:7:\"content\";i:2;s:4:\"exam\";i:3;s:6:\"course\";i:4;s:4:\"bank\";}', 'test', '', '', '', '32123456783245678x', '男', '13456789234', '本科', '河南省郑州市管城区某地', '');
